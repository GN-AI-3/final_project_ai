...
# db.run("SELECT * FROM member LIMIT 10;")
...
# print(get_schema_tool.invoke("member"))
...
# print(db_query_tool.invoke("SELECT * FROM member LIMIT 10;"))
...
# query_check.invoke({"messages": [("user", "SELECT * FROM member LIMIT 10;")]})
